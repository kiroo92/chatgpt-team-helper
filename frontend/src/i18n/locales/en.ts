export default {
  ...
  myOrders: {
    ...
    redemption: {
      ...
      summaryLatest: '{total} records, {banned} banned, {recoverable} recoverable, {recovered} recovered',
      exportRecent: 'Export Recent Recovery',
      exportFilenamePrefix: 'recovery-records',
      ...
      columns: {
        ...
        latestState: 'Latest Status',
        originalAccount: 'Original Account',
        currentAccount: 'Current Account',
        redeemTime: 'Redeemed At',
      ...
      toast: {
        recoverTriggered: 'Recovery triggered for {email}',
        recoverFailed: 'Recovery failed',
        reinviteSent: 'Invite resent',
        reinviteFailed: 'Failed to resend invite',
        noRecentRecovery: 'No recovery records in the last 30 days',
        exported: 'Exported {count} recovery records',
        exportFailed: 'Export failed',
      },
      log: {
        title: 'Operation Logs',
        desc: 'User Email: {email}',
        empty: 'No operation logs',
        typeInvite: 'Initial Invite',
        typeReinvite: 'Resend Invite',
