export default {
  ...
  myOrders: {
    ...
    redemption: {
      ...
      summaryLatest: '共 {total} 条，封号 {banned} 条，可补号 {recoverable} 条，已补号 {recovered} 条',
      exportRecent: '导出最近补号',
      exportFilenamePrefix: '补号记录',
      searchPlaceholder: '根据用户邮箱搜索',
      searchButton: '搜索',
      type: '兑换类型',
      email: '接收邮箱',
      account: '所属账号',
      ...
      toast: {
        recoverTriggered: '已为 {email} 触发补号',
        recoverFailed: '补号失败',
        reinviteSent: '重新邀请已发送',
        reinviteFailed: '重新邀请失败',
        noRecentRecovery: '最近30天没有可导出的补号记录',
        exported: '已导出 {count} 条补号记录',
        exportFailed: '导出失败',
      },
      log: {
        title: '操作记录',
